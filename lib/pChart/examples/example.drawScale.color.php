<?php   
 /* @ 700x230 Scales : Tuning axis colors drawing example. */
 ...
 $MyData->setAxisColor(0,array("R"=>225,"G"=>200,"B"=>83));
 $MyData->setAxisColor(1,array("R"=>203,"G"=>225,"B"=>83));
 $MyData->setAxisColor(2,array("R"=>225,"G"=>160,"B"=>83));
