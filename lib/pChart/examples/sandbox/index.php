...
<body>
  ...
  <table style='padding: 2px; background-color: #E0E0E0; border: 1px solid #D0D0D0;'><tr>
   ...
   <td class='topMenu'>
    <div class='topMenu' id='menu5' onmouseover='highlightDIV(5);' onmouseout='clearDIV(5);' onclick='toggleDIV(5);'>
     <table style='padding: 2px; border: 1px solid #D0D0D0;'><tr>
      <td class='topMenu'><img src='graphix/tab.png' width='16' height='16' alt=''/></td>
      <td class='topMenu'>&nbsp;Legend &amp; thresholds&nbsp;</td>
     </tr></table>
    </div>
   </td>
  </tr></table>
 ...
 <div class="roundedCorner" id='tab1' style='margin-top: 30px; margin-left: 20px; width: 350px; height: 420px; background: #F0F0F0; padding: 10px; color: #667309; border: 1px solid #E0E0E0'>
  ...
  <table><tr>
   ...
   <td>&nbsp;&nbsp; Color &nbsp;</td>
   <td><input type='text' class='color' id='g_title_color' value='#FFFFFF' style='width: 60px;' onmouseover='setFocus(this,true);' onmouseout='setFocus(this,false);' /></td>
   <td>&nbsp; <img src='graphix/wand.png' width='16' height='16' alt=''/></td>
  </tr></table>
  <table><tr>
  ...
  <table><tr>
   ...
   <td><input type='text' class='color' id='g_solid_color' value='#AAB757' style='width: 60px;' onmouseover='setFocus(this,true);' onmouseout='setFocus(this,false);' /></td>
   <td width='40'>&nbsp; <img src='graphix/wand.png' width='16' height='16' alt=''/></td>
  ...
  <table><tr>
   ...
   <td><input type='text' class='color' id='g_gradient_start' value='#DBE78B' style='width: 60px;' onmouseover='setFocus(this,true);' onmouseout='setFocus(this,false);' /></td>
   <td width='55'>&nbsp; <img src='graphix/wand.png' width='16' height='16' alt=''/></td>
   <td width='54'>End color &nbsp;</td>
   <td><input type='text' class='color' id='g_gradient_end' value='#018A44' style='width: 60px;' onmouseover='setFocus(this,true);' onmouseout='setFocus(this,false);' /></td>
   <td>&nbsp; <img src='graphix/wand.png' width='16' height='16' alt=''/></td>
  </tr></table>
  <table><tr>
...
?>
 ...
 <div class="roundedCorner" id='tab3' style='display: none; margin-top: 30px; margin-left: 20px; width: 350px; height: 435px; background: #F0F0F0; padding: 10px; color: #667309; border: 1px solid #E0E0E0'>
  ...
  <table><tr>
   ...
   <td>&nbsp; Color &nbsp;</td>
   <td><input type='text' id='s_font_color' class='color' value='#000000' style='width: 50px;' onmouseover='setFocus(this,true);' onmouseout='setFocus(this,false);' /></td>
   <td>&nbsp; <img src='graphix/wand.png' width='16' height='16' alt=''/></td>
  </tr></table>
  <br/>
  <table style='background-color: #E8E8E8; padding: 1px; border-top: 1px solid #F5F5F5; border-bottom: 1px solid #E0E0E0'><tr>
  ...
  <table><tr>
   ...
   <td><input type='text' id='s_grid_color' class='color' value='#FFFFFF' style='width: 60px; text-align: center' onmouseover='setFocus(this,true);' onmouseout='setFocus(this,false);' /></td>
   <td>&nbsp; <img src='graphix/wand.png' width='16' height='16' alt=''/></td>
   <td>&nbsp; Alpha</td>
  ...
  <table><tr>
   ...
   <td><input type='text' id='s_ticks_color' class='color' value='#000000' style='width: 60px; text-align: center' onmouseover='setFocus(this,true);' onmouseout='setFocus(this,false);' /></td>
   <td>&nbsp; <img src='graphix/wand.png' width='16' height='16' alt=''/></td>
   <td>&nbsp; Alpha</td>
  ...
  <table><tr>
   ...
   <td><input type='text' id='s_subticks_color' class='color' value='#FF0000' style='width: 60px; text-align: center' onmouseover='setFocus(this,true);' onmouseout='setFocus(this,false);' /></td>
   <td>&nbsp; <img src='graphix/wand.png' width='16' height='16' alt=''/></td>
   <td>&nbsp; Alpha</td>
 ...
 <div class="roundedCorner" id='tab5' style='display: none; margin-top: 30px; margin-left: 20px; width: 350px; height: 420px; background: #F0F0F0; padding: 10px; color: #667309; border: 1px solid #E0E0E0'>
  ...
  <table><tr>
   ...
   <td>&nbsp; Color &nbsp;</td>
   <td><input type='text' id='l_font_color' class='color' value='#000000' style='width: 50px;' onmouseover='setFocus(this,true);' onmouseout='setFocus(this,false);' /></td>
   <td>&nbsp; <img src='graphix/wand.png' width='16' height='16' alt=''/></td>
  </tr></table>
  <table><tr>
  ...
  <table><tr>
   ...
   <td><input type='text' id='t_color' class='color' value='#000000' style='width: 50px;' onmouseover='setFocus(this,true);' onmouseout='setFocus(this,false);' /></td>
   <td>&nbsp;&nbsp; <img src='graphix/wand.png' width='16' height='16' alt=''/></td>
   <td>&nbsp; Alpha &nbsp;</td>
